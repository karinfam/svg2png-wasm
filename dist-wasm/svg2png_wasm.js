...
* @returns {Converter}
*/
export function createConverter(default_serif_family, default_sans_serif_family, default_cursive_family, default_fantasy_family, default_monospace_family) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('svg2png_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
